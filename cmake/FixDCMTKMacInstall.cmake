  ...
  foreach(lib dcmdata dcmimage dcmimgle dcmjpeg dcmnet dcmpstat dcmqrdb dcmsr dcmtls ijg12 ijg16 ijg8 oflog ofstd)
    if (EXISTS ${DCMTK_ROOT}/lib/lib${lib}.dylib)
      foreach(linkedlib dcmdata dcmimage dcmimgle dcmjpeg dcmnet dcmpstat dcmqrdb dcmsr dcmtls ijg12 ijg16 ijg8 oflog ofstd)
        if (EXISTS ${DCMTK_ROOT}/lib/lib${linkedlib}.dylib)
          execute_process(COMMAND ${CMAKE_INSTALL_NAME_TOOL} -change lib${linkedlib}.dylib ${DCMTK_ROOT}/lib/lib${linkedlib}.dylib ${DCMTK_ROOT}/lib/lib${lib}.dylib)
        endif()
      endforeach()
    endif()
  endforeach()
